...
API_KEY = ''#Apk key fetch from google cloud
CSE_ID = ''#cse id from https://programmablesearchengine.google.com/controlpanel/create
...
def send_email(recipient_email, zip_file_path):
    ...
    password = ''# app password available through manage account 
...
def generate_image():
    ...
    return jsonify({"message": f"image generation started. The file will be sent to {recipient_email} when ready."})
